...
data, scaler = load_data(r"C:\Users\saffu\PycharmProjects\realtimetrafficmanagement\METR-LA.csv")
...
class TrafficEnv(gym.Env):
    def __init__(self):
        ...
        self.action_space = spaces.Discrete(3)  # 0: Short Red, 1: Balanced, 2: Short Green
...
def optimize():
    ...
    action = np.argmax(dqn_model.predict(np.array([state]), verbose=0)[0])
